...
def _normalize_extensions_input(exts: Union[str, Iterable]) -> List[str]:
    """
...
def definer(type_arg: Union[str, Iterable[str]], extensions_suported: Union[str, Iterable], overwrite: bool = False):
    """
    ...
    exts = _normalize_extensions_input(extensions_suported)
